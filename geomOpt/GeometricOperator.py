...
class GeometricOperator:
    ...
    def getOperatorVector(self, order, is_centered, is_scaled):
        ...
        operator_names = np.array([str((p, q, r)) for p, q, r in pqr])
...
if __name__ == '__main__':
    ...
    for design_num in range(1400):
        ...
        design_path = Path(r"H:\152 DM-BAR tanker optimisation - General\C- Naval Arch\Dimension Reduction\design "
                           r"reconstrcution\meshed Designs") / f"meshDesign{design_num}.stl"
        ...
        try:
            ...
            save_path = Path(
                r"C:\Users\Shahroz.Khan\OneDrive - BA Technologies Ltd\Documents\operators") / f"operators_{design_num}.csv"
            np.savetxt(save_path, operator_vector, delimiter=',')
        except FileNotFoundError:
            print(f"Design file {design_path} not found.")
            continue

    combined_save_path = r"C:\Users\Shahroz.Khan\OneDrive - BA Technologies Ltd\Documents\operators\operators_all.csv"
